        ...
        <s:else>
            ...
            <jsp:include page="sidebar.jsp"></jsp:include>   
                <div class="page-inner">
                    ...
                    <s:property value="#session.USER.getUsername"></s:property>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="panel panel-white">
                                    ...
                                    <s:form action="AddBook" method="POST" cssClass="form-horizontal" enctype="multipart/form-data">
                                        <s:token/>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Tên sách</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="title" class="form-control" id="input-Default txtFullName" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Tác giả</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="author" class="form-control date-picker" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Mô tả</label>
                                            <div class="col-sm-10">
                                                <textarea name="description" class="form-control" id="input-Default" autocomplete="off"></textarea>
                                                <!--<input type="text" name="description" class="form-control" id="input-Default" autocomplete="off">-->
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Giá</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="price" class="form-control" id="input-Default" value="<s:property value="Description"/>" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="custom-file">
                                                    <input type="file" name="bookImage" class="custom-file-input" required="">
