<%-- 
    Document   : edit_user
    Created on : Nov 23, 2017, 3:24:25 PM
    Author     : shadyside
--%>
                    ...
                    <div class="page-title">
                        ...
                        <div class="page-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Suathongtintaikhoan</li>
                            </ol>
                        </div>
                    </div>
                    <div id="main-wrapper">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="panel panel-white">
                                    ...
                                    <s:form action="EditUser" method="POST" cssClass="form-horizontal" enctype="multipart/form-data">
                                        <s:iterator value="user">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="fullname" class="form-control" id="input-Default" value="<s:property value="Fullname"/>" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="input-Default" class="col-sm-2 control-label">Email</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="email" class="form-control" id="input-Default" value="<s:property value="Email"/>" autocomplete="off">
                                                    <s:if test="mailError !=''">
