<%-- 
    ...
    Created on : Nov 12, 2017, 9:19:55 PM
    Author     : shadyside
--%>
                ...
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Doithongtintaikhoan</li>
                        </ol>
                    </div>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                ...
                                <s:form action="EditProfile" method="POST" cssClass="form-horizontal" enctype="multipart/form-data">
                                    <s:iterator value="#session.USER">
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">FullName</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="fullname" class="form-control" id="input-Default txtFullName" value="<s:property value="Fullname"/>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="email" class="form-control date-picker"  value="<s:property value="Email"/>">
                                                <s:if test="error !=''">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <s:a href="%{RedirectCustomer}"><button type="button" class="btn btn-default">&nbsp;&nbsp;&nbsp;Hủy&nbsp;&nbsp;&nbsp;</button></s:a>
                                            </div>
                                    </s:iterator>
                                </s:form>
                            </div>
